...
- **Pinned CLI:** `evalshift==1.0.0` by default, overridable.
...
### `pip install evalshift==1.0.0` fails

`python-version` is below the CLI's minimum. EvalShift 1.0.0 needs Python 3.11+.
